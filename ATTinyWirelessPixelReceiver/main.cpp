...
int main(void)
{
  ...
  setRGB(0, 0x70, 0x00, 0x00, 500);
  setRGB(1, 0x00, 0x70, 0x00, 500);
  setRGB(2, 0x00, 0x00, 0x70, 500);
  setRGB(3, 0x30, 0x30, 0x30, 500);
  setRGB(0, 0x30, 0x30, 0x30, 500);
  setRGB(1, 0x30, 0x30, 0x30, 500);
  setRGB(2, 0x30, 0x30, 0x30, 500);
  setRGB(3, 0x30, 0x30, 0x30, 500);
  setRGB(0, 0xFF, 0xFF, 0xFF, 250);
  setRGB(1, 0xFF, 0xFF, 0xFF, 250);
  setRGB(2, 0xFF, 0xFF, 0xFF, 250);
  setRGB(3, 0xFF, 0xFF, 0xFF, 250);
  setRGB(0, 0x00, 0x00, 0x00, 10);
  setRGB(1, 0x00, 0x00, 0x00, 10);
  setRGB(2, 0x00, 0x00, 0x00, 10);
  setRGB(3, 0x00, 0x00, 0x00, 10);
